#Culling
> Basic surface culling.

[![Build Status](https://travis-ci.org/redwoodfavorite/culling.svg?branch=master)](https://travis-ci.org/redwoodfavorite/culling) [![Dependency Status](https://david-dm.org/redwoodfavorite/culling.svg)](https://david-dm.org/redwoodfavorite/culling) [![devDependency Status](https://david-dm.org/redwoodfavorite/culling/dev-status.svg)](https://david-dm.org/redwoodfavorite/culling#info=devDependencies)
...
## Release History
 * 2014-06-01   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)